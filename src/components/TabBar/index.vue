<template>
	<footer id="footer">
		<ul>
			<router-link tag="li" to="/movie" class="iconfont icon-dianying">
				<p>电影</p>
			</router-link >
			<router-link tag="li" to="/cinema" class="iconfont icon-dianying">
				<p>影院</p>
			</router-link >
			<router-link tag="li" to="/mine" class="iconfont icon-dianying">
				<p>我的</p>
			</router-link >
		</ul>
	</footer>
